...
int main(int argc, char *argv[])
{
    ...
    for (n = 0; n < ndev; n++) {
...
#else
        {
            ...
            /* <<--regs-config-->> */
		iowrite32(dev, PULP_CLUSTER_REG1_REG, reg1);
		iowrite32(dev, PULP_CLUSTER_REG3_REG, reg3);
		iowrite32(dev, PULP_CLUSTER_REG2_REG, reg2);
